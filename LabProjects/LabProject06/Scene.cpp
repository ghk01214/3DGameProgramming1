...
{
	// Graphic Root Siganture를 Pipeline에 연결(설정)
	pd3dCommandList->SetGraphicsRootSignature(m_pd3dGraphicsRootSignature);

	// Scene을 Rendering하는 것은 Scene을 구성하는 Shader(Shader가 포함하는 객체)들을 렌더링하는 것
	for (INT i = 0; i < m_nShaders; ++i)
	{
