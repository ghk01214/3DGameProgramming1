...
public:
	...
	void OnDestroy();
public:																										// Swap Chain 생성 함수
	void CreateSwapChain();																					// 서술자 Heap 생성 함수
	void CreateRtvAndDsvDescriptorHeaps();																	// Direct3D Device 생성 함수
	void CreateDirect3DDevice();																			// 명령 Queue/할당자/List 생성 함수
	void CreateCommandQueueAndList();
public:																										// Render Target View 생성 함수
	void CreateRenderTargetViews();																			// Depth-Stencil View 생성 함수
	void CreateDepthStencilView();
public:																										// Rendering할 Mesh와 게임 객체 생성 함수
	void BuildObjects();																					// 게임 객체 소멸 함수
	void ReleaseObjects();
public:
