...
public:
	void GenerateFrustum();																   // 절두체(월드 좌표계) 생성
public:
...
public:
	BOOL IsInFrustum(BoundingOrientedBox& xmBoundingBox) { return m_xmFrustum.Intersects(xmBoundingBox); }  // Bounding Box(OOBB, 월드 좌표계)가 절두체에 포함되는 가를 검사
public:
