...
//정점의 색상을 무작위로(Random) 설정하기 위해 사용. 각 정점의 색상은 난수(Random Number)를 생성 후 지정
#define RANDOM_COLOR XMFLOAT4(rand() / (FLOAT)RAND_MAX, rand() / (FLOAT)RAND_MAX, rand() / (FLOAT)RAND_MAX, rand() / (FLOAT)RAND_MAX)
//#define RANDOM_COLOR XMFLOAT4(uid(dre) / (FLOAT)RAND_MAX, uid(dre) / (FLOAT)RAND_MAX, uid(dre) / (FLOAT)RAND_MAX, uid(dre) / (FLOAT)RAND_MAX)
