...
CGameFramework::CGameFramework()
{
	...
	_tcscpy_s(m_pszFrameRate, _T("LabProject10 ("));
}
...
void CGameFramework::ProcessInput()
{
	...
	/*마우스를 캡쳐했으면 마우스가 얼마만큼 이동하였는 가를 계산. 마우스 왼쪽 또는 오른쪽 버튼이 눌러질 때의
	메시지(WM_LBUTTONDOWN, WM_RBUTTONDOWN)를 처리할 때 마우스를 캡쳐.
...
void CGameFramework::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYUP:
		...
		case VK_RETURN:
			break;
			// 'F1' 키를 누르면 1인칭 카메라, 'F2' 키를 누르면 Spaceship 카메라, 'F3' 키를 누르면 3인칭 카메라로 변경
		case VK_F1:
		case VK_F2:
		case VK_F3:
		{
